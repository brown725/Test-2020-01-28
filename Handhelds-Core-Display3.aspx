<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Handhelds-Core-Display3.aspx.cs" Inherits="Handhelds_Core_Display3" %>
...
<body>
    ...
    <div align="center"> 
        <br />
        <strong><span style="color: red">Handhelds - Core - Selected Country<br />
        </span>
        </strong>
        <br />   
