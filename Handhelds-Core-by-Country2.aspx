<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Handhelds-Core-by-Country2.aspx.cs" Inherits="Handhelds_Core_by_Country2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Handhelds - Core by Country</title>
</head>
<body>
    <form id="form1" runat="server">
    <div align="center"> 
        <br />
        <strong><span style="color: red">Handhelds - Core by Country<br />
        </span>
        </strong>
        <br />
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [Country], [Backpacks], [Pagers], [RIID], [Survey Meters] AS Survey_Meters, [Misc], [Total] FROM [Handhelds - Core Sites by Country] ORDER BY [Country]">
