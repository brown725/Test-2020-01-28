    ...
    <div>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Program_Type" HeaderText="Program" 
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [Country], [Site], [Program_Type], [Category Type] AS Category_Type, [Backpacks], [Pagers], [RIID], [Survey Meters] AS Survey_Meters, [Misc], [Total] FROM [Handhelds - Core by Site] ORDER BY [Country], [Site]">
